  ...
  return (
    <div className="flex flex-col md:flex-row gap-6">
            ...
            {images.map((image, index) => (
              ...
              >
                <Image
                  ...
                  onError={(e) => {
                    e.currentTarget.src = image; // fallback to original
                  }}
                />
              </div>
            ))}
      ...
      <div className="relative w-full max-w-full h-auto order-1 md:order-2">
        <div
          className="border rounded-lg overflow-hidden items-center justify-center relative border-gray-400 hidden md:flex"
        ...
        >
          <Image
            ...
            onError={(e) => {
              e.currentTarget.src = images[selectedImage]; // fallback to original
            }}
          />
        ...
        <div
          className="border rounded-lg overflow-hidden flex items-center justify-center relative border-gray-400 flex md:hidden"
          onMouseMove={handleMouseMove}
          onMouseEnter={() => setIsZooming(true)}
          onMouseLeave={() => setIsZooming(false)}
        >
